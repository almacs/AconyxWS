...
public class Error  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://common.webservice.sms.ngin.agnity.com/", "error"));
    ...
    public String toString(){
    	...
    	result.append("<Error>");
    	result.append("<Code>"+ this.getCode()+"</Code>");
    	result.append("<Message>"+ this.getMessage()+"</Message>");
    	result.append("</Error>");
